...
register(
    id='HummingbirdHoverTaskEnvPPO-v3',
    entry_point='hummingbird_hover_task_gt_env_ppo_baseline:HummingbirdHoverTaskEnv', #change this part as well when changing env
...
class HummingbirdHoverTaskEnv(hummingbird_hover_gt_env.HummingbirdHoverGtEnv):
    def __init__(self):
        ...
        LoadYamlFileParamsTest(rospackage_name="hummingbird_pkg",
                               ...
                               yaml_file_name="hummingbird_gt_ppo_params_baseline.yaml")    ### Need change
    ...
    def _is_done(self, observations):
        ...
        isout = self.is_out(current_position, current_distance, MAX_DISTANCE=1.7)
    ...
    def get_base_angular_vel(self):
        ...
        imu = self.get_imu()
        base_angular_vel = imu.angular_velocity
