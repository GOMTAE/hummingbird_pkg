...
register(
    id='HummingbirdHoverTaskEnvPPO-v1',
    entry_point='hummingbird_hover_task_env_ppo_baseline:HummingbirdHoverTaskEnv', #change this part as well when changing env
...
class HummingbirdHoverTaskEnv(hummingbird_hover_env.HummingbirdHoverEnv):
    def __init__(self):
        ...
        LoadYamlFileParamsTest(rospackage_name="hummingbird_pkg",
                               ...
                               yaml_file_name="hummingbird_ppo_params_baseline.yaml")    ### Need change
