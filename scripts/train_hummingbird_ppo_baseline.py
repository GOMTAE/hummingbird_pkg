...
# check log directory
log_dir = "/home/ubuntu/catkin_ws/src/hummingbird_pkg/results/trained_model/baseline/"
...
model_list = [
        ...
        PPO("MlpPolicy", env, policy_kwargs=dict(net_arch=[dict(pi=[256, 256], vf=[256, 256])], log_std_init=-0.5), verbose=0, learning_rate=lr, gae_lambda=0.94, n_steps=2048, batch_size=64, tensorboard_log="/home/ubuntu/catkin_ws/src/hummingbird_pkg/results/tensorboard_logs/PPO/baseline/"),
...
df.to_csv('/home/ubuntu/catkin_ws/src/hummingbird_pkg/results/trained_model/baseline/train_info.csv', index=False)
